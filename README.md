...
Only 15 strains showing here in the table.
...
This finding indicates that the Africa2 lineage possess region-specific structures distinct from other populations. Only 15 strains showing here in the table.
